...
import { CHART_BLUE, chartAxisTickStyle, chartTooltipContentStyle, chartTooltipItemStyle, chartTooltipLabelStyle } from "@/lib/chart-theme";
          ...
          {isLoading ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData}>
                ...
                />
                <Bar dataKey="fuel_efficiency_km_per_l" name="km/L" fill={CHART_BLUE} />
              </BarChart>
            </ResponsiveContainer>
          ) : (
